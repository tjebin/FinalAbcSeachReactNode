...
import {
    ...
    Button, Form, FormGroup, Label, Input, Col, FormFeedback, Card
} from 'reactstrap';
                                            ...
                                            <Col md={3} >
                                                <div class="input-icons">
                                                    ...
                                                    {this.state.showOptions && flteredFromPlaces.length > 0 &&
                                                        <div style={{
                                                            width: '40%', padding: '12px', border: '1px solid pink', fontSize: '12px',
                                                            borderRadius: '3px'
                                                        }}>
                                                            {flteredFromPlaces}
                                                        </div>
                                            ...
                                            <Col md={3}>
                                                <div class="input-icons">
                                                    ...
                                                    <DayPickerInput
                                                        ...
                                                        inputProps={{
                                                            style: {
                                                                width: '170px', height: '38px', border: '1px solid green',
                                                                paddingLeft: '20px',
                                                                borderRadius: '3px'
                                                            }
                                                        }}
